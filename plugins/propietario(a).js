...
if (!fs.existsSync(`./Лисенок/${conn.user.jid.split`@`[0]}/creds.json`)) {
...
const path = conn.user.jid != global.conn.user.jid ? `./Лисенок/${conn.user.jid.split`@`[0]}/creds.json` : `./GataBotSession/creds.json`
